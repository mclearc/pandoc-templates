...
$endif$
$if(sansfont)$
\setsansfont[Numbers=OldStyle,Scale=MatchLowercase,Mapping=tex-text]{$sansfont$}
$else$
\setsansfont[Numbers=OldStyle,Scale=MatchLowercase,Mapping=tex-text]{Gill Sans}
$endif$
...
$endif$
\chead{}
$if(lfoot)$\lfoot{\footnotesize{$lfoot$}}
$else$
